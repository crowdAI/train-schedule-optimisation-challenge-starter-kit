...
* In [a worked example](documentation/a_worked_example.md) we solve a simple [sample problem instance](smaple_files/sample_scenario.json) "on paper" from the ground up. <br>
