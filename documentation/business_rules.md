...
| -------           | -----             | ----    |
| verkehrsplanHash (problem_instance_hash) present      | the fiel _verkehrsplanHash_ (_problem_instance_hash_) is present in the solution                           | |
